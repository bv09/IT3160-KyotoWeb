  ...
  return (
    <SwitchPrimitive.Root
      ...
      className={cn(
        ...
        "data-checked:border-indigo-600 data-checked:bg-indigo-600 data-unchecked:border-slate-400 data-unchecked:bg-slate-400 dark:data-unchecked:border-slate-500 dark:data-unchecked:bg-slate-500",
        className
      )}
      {...props}
    >
